import { Box, Divider, Heading, Flex, Spinner, Text, Grid, GridItem } from '@chakra-ui/react';
    ...
    return (
        <Box p="4" width="100%" height="100%" pt="64px">
            ...
            <Flex direction="row" justifyContent="space-between">
                <Box width="100%">
                    <ChartWrapper title="Temperature in Garage (°F)" weatherData={watchdogData} metric="temp">
                        <LineChart data={watchdogData} metric="temp" />
                    </ChartWrapper>
                    <Divider my="8" borderColor="#212121" borderWidth="4px" borderRadius="full" />
                    <ChartWrapper title="Humidity in Garage (%)" weatherData={watchdogData} metric="hum">
